<!DOCTYPE html>
    <html lang="en">
        ...
        <meta charset="UTF-8">
            ...
            <title>Academic Management System - Admin</title>
        </head>
        <body>
            <!--Start Header-->
            <header>
                    ...
                    <div id="collapsable-navbar" class="collapse navbar-collapse text-center">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown nav-sm-size">
                                ...
                                <a class="dropdown-item nav-sm-size" href="employees.php">Add/Edit Employees</a>
                                <a class="dropdown-item nav-sm-size" href="students.php">Add/Edit Students</a>
                            </div>
                            </li>
                            <li class="nav-item dropdown nav-sm-size">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu dropdown-menu-right text-center" aria-labelledby="nav-dropdown">
                                <a class="dropdown-item nav-sm-size" href="exams.php">Add/Edit Subjects</a>
                                <a class="dropdown-item nav-sm-size" href="questions.php">Add/Edit Questions</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item nav-sm-size" href="previous_results.php">View Previous Examination Results</a>
                            </div>
                            </li>
                            <li class="nav-item dropdown nav-sm-size">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
