            ...
            <div id="main-content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <hr>
                        <button class="btn btn-primary rounded-pill" type="button" data-toggle="modal" data-target="#modal-addnewstudent">Add a Student</button>
                        <br><br>
                            <div id="modal-addnewstudent" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
...
<?php
    if(isset($_POST["submit-student"])) {
        $sql="INSERT INTO registration VALUE(NULL,'$_POST[username]','$_POST[password]')";
        $result=$mysqli->query($sql);
        if($result === TRUE) {
?>
<script type="text/javascript">
